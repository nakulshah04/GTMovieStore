...
def add_review(request, movie_id):
    ...
    if review_id:
        ...
        review = get_object_or_404(Review, id=review_id, user=request.user, movie=movie)
...
def delete_review(request, movie_id, review_id):
    review = get_object_or_404(Review, id=review_id, user=request.user, movie_id=movie_id)
    review.delete()
